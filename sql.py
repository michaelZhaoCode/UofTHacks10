...
def create_messages_table():
    ...
    command = f"CREATE TABLE IF NOT EXISTS messages (id INTEGER PRIMARY KEY AUTOINCREMENT, user INTEGER, message nvarchar(100))"
    mycursor.execute(command)
    conn.commit()

def insert_message(user: int, message:str):
